...
export function VolumeControl({ volume, onChange }: VolumeControlProps) {
  return (
    <div>
      <p className="text-sm font-medium text-ink-800">Volume</p>
...
function SpeakerIcon({ muted }: { muted: boolean }) {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="shrink-0 text-ink-700">
